...
const Details = () => {
  ...
  const [oneRecipe, setOneRecepe] = useState([]);
  ...
  // --- youtube-link
  const videoLink = () => {
    window.location.href = `${testobject.strYoutube}`;
  };
  return (
    <>
      <div className="detail-wrapper">
        <img src={testobject.strMealThumb} alt="testobject.strMeal" />
        <div className="detail">
          <h1>{testobject.strMeal}</h1>
          <h2>Breakfast</h2>
          <h2>{testobject.strArea}</h2>
          {/* <div className="buttons">
            <div
              className={
                ingredients ? "button-ingredents" : "button-instructions"
              }
            >
              <IngredientsDark />
            </div>
          ...
          <div className="buttons" onClick={buttonToggle}>
            {ingredients ? (
              <>
                <IngredientsDark />
              </>
          ...
          {ingredients ? (
            <div className="detail-ingredients">
              <h3>Ingredients</h3>
              {testobject.strMeasure1 ? (
                <p>
                  {testobject.strMeasure1} {testobject.strIngredient1}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure2 ? (
                <p>
                  {testobject.strMeasure2} {testobject.strIngredient2}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure3 ? (
                <p>
                  {testobject.strMeasure3} {testobject.strIngredient3}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure4 ? (
                <p>
                  {testobject.strMeasure4} {testobject.strIngredient4}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure5 ? (
                <p>
                  {testobject.strMeasure5} {testobject.strIngredient5}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure6 ? (
                <p>
                  {testobject.strMeasure6} {testobject.strIngredient6}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure7 ? (
                <p>
                  {testobject.strMeasure7} {testobject.strIngredient7}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure8 ? (
                <p>
                  {testobject.strMeasure8} {testobject.strIngredient8}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure9 ? (
                <p>
                  {testobject.strMeasure9} {testobject.strIngredient9}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure10 ? (
                <p>
                  {testobject.strMeasure10} {testobject.strIngredient10}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure11 ? (
                <p>
                  {testobject.strMeasure11} {testobject.strIngredient11}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure12 ? (
                <p>
                  {testobject.strMeasure12} {testobject.strIngredient12}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure13 ? (
                <p>
                  {testobject.strMeasure13} {testobject.strIngredient13}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure14 ? (
                <p>
                  {testobject.strMeasure14} {testobject.strIngredient14}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure15 ? (
                <p>
                  {testobject.strMeasure15} {testobject.strIngredient15}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure16 ? (
                <p>
                  {testobject.strMeasure16} {testobject.strIngredient16}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure17 ? (
                <p>
                  {testobject.strMeasure17} {testobject.strIngredient17}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure18 ? (
                <p>
                  {testobject.strMeasure18} {testobject.strIngredient18}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure19 ? (
                <p>
                  {testobject.strMeasure19} {testobject.strIngredient19}
                </p>
              ) : (
                ""
              )}
              {testobject.strMeasure20 ? (
                <p>
                  {testobject.strMeasure20} {testobject.strIngredient20}
                </p>
              ) : (
                ""
              )}
            ...
            <div className="detail-instructions">
              <h3>Instructions</h3>
              <p>{testobject.strInstructions}</p>
